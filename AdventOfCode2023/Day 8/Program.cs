...
{
  private static readonly Regex _pathRegex = PathRegex();

  public static void Main()
  {
    var parsed = ParseInput(_input);
    var length = GetPathLength(parsed.Path, parsed.Item2);
  ...
  private static (string Path, Dictionary<string, (string, string)> Coordinates) ParseInput(string input)
  {
    ...
    {
      var line = lines[i];
      var parsed = _pathRegex.Match(line);

      directions.Add(parsed.Groups[1].ToString(), (parsed.Groups[2].ToString(), parsed.Groups[3].ToString()));
    }
